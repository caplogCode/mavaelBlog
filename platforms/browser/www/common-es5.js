(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function (module, __webpack_exports__, __webpack_require__) {
    ...
    let PostsService = class PostsService {
      constructor(afs) {
        this.afs = afs;
        this.mavaelCol = this.afs.collection("posts", ref => ref.orderBy("timestamp", "desc"));
        this.posts = this.mavaelCol.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(action => {
          return action.map(a => {
      ...
      getPost(postId) {
        ...
        this.mavaelDoc = this.afs.doc(posting);
    ...
    PostsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]])], PostsService);
    /***/
  }
}]);
